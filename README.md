...
## Related
- [`@nostrwatch/schemata-js-ajv`](https://www.npmjs.com/package/@nostrwatch/schemata-js-ajv) - Typescript library for validating nostr events, depends on this package.
